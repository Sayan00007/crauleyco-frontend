        ...
        <section id="bags" className="py-16 md:py-24 px-4 md:px-8">
            <div className="container mx-auto">
                ...
                <motion.h2
                    ...
                    className="font-syne text-3xl md:text-5xl font-extrabold text-[#09090b] mb-10"
                >
                    Bags
                </motion.h2>
                ...
                <motion.h2
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.6 }}
                    className="font-syne text-3xl md:text-5xl font-extrabold text-[#09090b] mb-10 mt-16 md:mt-24"
                >
                    Greeting Cards
                </motion.h2>
                <div className="flex gap-4 md:gap-6 overflow-x-auto pb-6 snap-x snap-mandatory scrollbar-hide">
